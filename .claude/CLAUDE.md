...
| Node | Role(s) | RAM | vCPU | OS Disk | Ceph OSD Disk |
|------|---------|-----|------|---------|---------------|
...
| node3 | Storage / Cinder (+ Ceph OSD later) | 12 GB | 2 | 30 GB | 20 GB (pre-provisioned) |

- **Totals:** 72 GB RAM, 12 vCPU, 130 GB OS disk, 40 GB Ceph OSD disk (unused initially)
